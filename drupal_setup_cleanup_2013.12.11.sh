...
cd sites/all/libraries
#       Check link for latest version (current latest: 5.0.3 - 2013/12/11 13:26:55)
#       @see http://swiftmailer.org/
wget http://swiftmailer.org/download_file/Swift-5.0.3.tar.gz --quiet
tar -zxf Swift-5.0.3.tar.gz
mv Swift-5.0.3 swiftmailer
rm Swift-5.0.3.tar.gz
chown $DEFAULT_UNIX_OWNER:$DEFAULT_UNIX_GROUP . -R
chmod $DEFAULT_UNIX_MOD . -R
cd ../../../
